...
//  CHECK-NEXT:   %[[TMP0:.+]] = mhlo.add %[[IN0]], %[[IN1]] : tensor<?x8x8x3xf32>
//  CHECK-NEXT:   %[[TMP1:.+]] = mhlo.add %[[TMP0]], %[[IN0]] : tensor<?x8x8x3xf32>
//  CHECK-NEXT:   %[[OUT0_SHAPE:.+]] = shapex.get_ranked_shape %[[TMP0]] : tensor<?x8x8x3xf32> -> !shapex.ranked_shape<[?,8,8,3]>
//  CHECK-NEXT:   flow.variable.store %[[OUT0_SHAPE]], @_tflite_dynamicEntry_output0_shape : !shapex.ranked_shape<[?,8,8,3]>
//  CHECK-NEXT:   %[[OUT1_SHAPE:.+]] = shapex.get_ranked_shape %[[TMP1]] : tensor<?x8x8x3xf32> -> !shapex.ranked_shape<[?,8,8,3]>
